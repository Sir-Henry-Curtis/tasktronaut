...
- Use "${mcpDetails.mcpId}" as the server name in the MCP settings file.
- Create the directory for the new MCP server before starting installation.
- Make sure you read the user's existing MCP settings file before editing it with this new MCP so you do not overwrite any existing servers.
