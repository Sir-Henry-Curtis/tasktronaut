...
export class VscodeCommentReviewController extends CommentReviewController implements vscode.Disposable {
	...
	constructor() {
		...
		this.commentController = vscode.comments.createCommentController("tasktronaut-ai-review", "Tasktronaut AI Review")

		// Configure options for the reply input
		this.commentController.options = {
			placeHolder: "Ask a question about this code...",
			prompt: "Reply to Tasktronaut",
		}
		...
		this.disposables.push(
			vscode.commands.registerCommand("tasktronaut.reviewComment.reply", async (reply: vscode.CommentReply) => {
		...
		this.disposables.push(
			vscode.commands.registerCommand("tasktronaut.reviewComment.addToChat", async (thread: vscode.CommentThread) => {
