...
async function performCommitMsgGeneration(controller: Controller, gitDiff: string, inputBox: any) {
	try {
		vscode.commands.executeCommand("setContext", "tasktronaut.isGeneratingCommit", true)
		...
		vscode.commands.executeCommand("setContext", "tasktronaut.isGeneratingCommit", false)
	}
}
