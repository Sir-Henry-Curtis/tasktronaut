...
export function convertApiConfigurationToProto(config: ApiConfiguration): ProtoApiConfiguration {
	return {
		...
		kissModeApiProvider: config.kissModeApiProvider ? convertApiProviderToProto(config.kissModeApiProvider) : undefined,
		kissModeApiModelId: config.kissModeApiModelId,
		kissModeThinkingBudgetTokens: config.kissModeThinkingBudgetTokens,
		geminiKissModeThinkingLevel: config.geminiKissModeThinkingLevel,
		kissModeReasoningEffort: config.kissModeReasoningEffort,
		kissModeVsCodeLmModelSelector: config.kissModeVsCodeLmModelSelector,
		kissModeAwsBedrockCustomSelected: config.kissModeAwsBedrockCustomSelected,
		kissModeAwsBedrockCustomModelBaseId: config.kissModeAwsBedrockCustomModelBaseId as string | undefined,
		kissModeOpenRouterModelId: config.kissModeOpenRouterModelId,
		kissModeOpenRouterModelInfo: convertModelInfoToProtoOpenRouter(config.kissModeOpenRouterModelInfo),
		kissModeClineModelId: config.kissModeClineModelId,
		kissModeClineModelInfo: convertModelInfoToProtoOpenRouter(config.kissModeClineModelInfo),
		kissModeOpenAiModelId: config.kissModeOpenAiModelId,
		kissModeOpenAiModelInfo: convertOpenAiCompatibleModelInfoToProto(config.kissModeOpenAiModelInfo),
		kissModeOllamaModelId: config.kissModeOllamaModelId,
		kissModeLmStudioModelId: config.kissModeLmStudioModelId,
		kissModeLiteLlmModelId: config.kissModeLiteLlmModelId,
		kissModeLiteLlmModelInfo: convertLiteLLMModelInfoToProto(config.kissModeLiteLlmModelInfo),
		kissModeRequestyModelId: config.kissModeRequestyModelId,
		kissModeRequestyModelInfo: convertModelInfoToProtoOpenRouter(config.kissModeRequestyModelInfo),
		kissModeTogetherModelId: config.kissModeTogetherModelId,
		kissModeFireworksModelId: config.kissModeFireworksModelId,
		kissModeGroqModelId: config.kissModeGroqModelId,
		kissModeGroqModelInfo: convertModelInfoToProtoOpenRouter(config.kissModeGroqModelInfo),
		kissModeBasetenModelId: config.kissModeBasetenModelId,
		kissModeBasetenModelInfo: convertModelInfoToProtoOpenRouter(config.kissModeBasetenModelInfo),
		kissModeHuggingFaceModelId: config.kissModeHuggingFaceModelId,
		kissModeHuggingFaceModelInfo: convertModelInfoToProtoOpenRouter(config.kissModeHuggingFaceModelInfo),
		kissModeSapAiCoreModelId: config.kissModeSapAiCoreModelId,
		kissModeHuaweiCloudMaasModelId: config.kissModeHuaweiCloudMaasModelId,
		kissModeHuaweiCloudMaasModelInfo: convertModelInfoToProtoOpenRouter(config.kissModeHuaweiCloudMaasModelInfo),
		kissModeSapAiCoreDeploymentId: config.kissModeSapAiCoreDeploymentId,
		kissModeOcaModelId: config.kissModeOcaModelId,
		kissModeOcaModelInfo: convertOcaModelInfoToProtoOcaModelInfo(config.kissModeOcaModelInfo),
		kissModeOcaReasoningEffort: config.kissModeOcaReasoningEffort,
		kissModeAihubmixModelId: config.kissModeAihubmixModelId,
		kissModeAihubmixModelInfo: convertOpenAiCompatibleModelInfoToProto(config.kissModeAihubmixModelInfo),
		kissModeHicapModelId: config.kissModeHicapModelId,
		kissModeHicapModelInfo: convertModelInfoToProtoOpenRouter(config.kissModeHicapModelInfo),
		kissModeNousResearchModelId: config.kissModeNousResearchModelId,
		kissModeVercelAiGatewayModelId: config.kissModeVercelAiGatewayModelId,
		kissModeVercelAiGatewayModelInfo: convertModelInfoToProtoOpenRouter(config.kissModeVercelAiGatewayModelInfo),
	}
}
...
export function convertProtoToApiConfiguration(protoConfig: ProtoApiConfiguration): ApiConfiguration {
	return {
		...
		// Kiss mode configurations
		kissModeApiProvider:
			protoConfig.kissModeApiProvider !== undefined
				? convertProtoToApiProvider(protoConfig.kissModeApiProvider)
				: undefined,
		kissModeApiModelId: protoConfig.kissModeApiModelId,
		kissModeThinkingBudgetTokens: protoConfig.kissModeThinkingBudgetTokens,
		geminiKissModeThinkingLevel: protoConfig.geminiKissModeThinkingLevel,
		kissModeReasoningEffort: protoConfig.kissModeReasoningEffort as OpenaiReasoningEffort | undefined,
		kissModeVsCodeLmModelSelector: protoConfig.kissModeVsCodeLmModelSelector,
		kissModeAwsBedrockCustomSelected: protoConfig.kissModeAwsBedrockCustomSelected,
		kissModeAwsBedrockCustomModelBaseId: protoConfig.kissModeAwsBedrockCustomModelBaseId as BedrockModelId | undefined,
		kissModeOpenRouterModelId: protoConfig.kissModeOpenRouterModelId,
		kissModeOpenRouterModelInfo: convertProtoToModelInfo(protoConfig.kissModeOpenRouterModelInfo),
		kissModeClineModelId: protoConfig.kissModeClineModelId,
		kissModeClineModelInfo: convertProtoToModelInfo(protoConfig.kissModeClineModelInfo),
		kissModeOpenAiModelId: protoConfig.kissModeOpenAiModelId,
		kissModeOpenAiModelInfo: convertProtoToOpenAiCompatibleModelInfo(protoConfig.kissModeOpenAiModelInfo),
		kissModeOllamaModelId: protoConfig.kissModeOllamaModelId,
		kissModeLmStudioModelId: protoConfig.kissModeLmStudioModelId,
		kissModeLiteLlmModelId: protoConfig.kissModeLiteLlmModelId,
		kissModeLiteLlmModelInfo: convertProtoToLiteLLMModelInfo(protoConfig.kissModeLiteLlmModelInfo),
		kissModeRequestyModelId: protoConfig.kissModeRequestyModelId,
		kissModeRequestyModelInfo: convertProtoToModelInfo(protoConfig.kissModeRequestyModelInfo),
		kissModeTogetherModelId: protoConfig.kissModeTogetherModelId,
		kissModeFireworksModelId: protoConfig.kissModeFireworksModelId,
		kissModeGroqModelId: protoConfig.kissModeGroqModelId,
		kissModeGroqModelInfo: convertProtoToModelInfo(protoConfig.kissModeGroqModelInfo),
		kissModeBasetenModelId: protoConfig.kissModeBasetenModelId,
		kissModeBasetenModelInfo: convertProtoToModelInfo(protoConfig.kissModeBasetenModelInfo),
		kissModeHuggingFaceModelId: protoConfig.kissModeHuggingFaceModelId,
		kissModeHuggingFaceModelInfo: convertProtoToModelInfo(protoConfig.kissModeHuggingFaceModelInfo),
		kissModeSapAiCoreModelId: protoConfig.kissModeSapAiCoreModelId,
		kissModeHuaweiCloudMaasModelId: protoConfig.kissModeHuaweiCloudMaasModelId,
		kissModeHuaweiCloudMaasModelInfo: convertProtoToModelInfo(protoConfig.kissModeHuaweiCloudMaasModelInfo),
		kissModeSapAiCoreDeploymentId: protoConfig.kissModeSapAiCoreDeploymentId,
		kissModeOcaModelId: protoConfig.kissModeOcaModelId,
		kissModeOcaModelInfo: convertProtoOcaModelInfoToOcaModelInfo(protoConfig.kissModeOcaModelInfo),
		kissModeOcaReasoningEffort: protoConfig.kissModeOcaReasoningEffort,
		kissModeAihubmixModelId: protoConfig.kissModeAihubmixModelId,
		kissModeAihubmixModelInfo: convertProtoToOpenAiCompatibleModelInfo(protoConfig.kissModeAihubmixModelInfo),
		kissModeHicapModelId: protoConfig.kissModeHicapModelId,
		kissModeHicapModelInfo: convertProtoToModelInfo(protoConfig.kissModeHicapModelInfo),
		kissModeNousResearchModelId: protoConfig.kissModeNousResearchModelId,
		kissModeVercelAiGatewayModelId: protoConfig.kissModeVercelAiGatewayModelId,
		kissModeVercelAiGatewayModelInfo: convertProtoToModelInfo(protoConfig.kissModeVercelAiGatewayModelInfo),
	}
}
