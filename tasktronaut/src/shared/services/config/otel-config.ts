...
function getDisabledOtelConfig(): OpenTelemetryClientConfig {
	return { enabled: false }
}

export function remoteConfigToOtelConfig(): OpenTelemetryClientConfig {
	return getDisabledOtelConfig()
}
