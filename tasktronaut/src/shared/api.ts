...
export const SUPPORTED_API_PROVIDER = "openai" as const satisfies ApiProvider
export const DEFAULT_API_PROVIDER = SUPPORTED_API_PROVIDER as ApiProvider

export function coerceSupportedApiProvider(provider?: ApiProvider): ApiProvider {
	return provider === SUPPORTED_API_PROVIDER ? provider : SUPPORTED_API_PROVIDER
}
