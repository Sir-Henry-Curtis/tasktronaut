...
describe("ClineEndpoint configuration", () => {
	...
	beforeEach(async () => {
		...
		// Create .tasktronaut directory
		await fs.mkdir(path.join(tempDir, ".tasktronaut"), { recursive: true })
	...
	describe("valid config parsing", () => {
		it("should parse valid endpoints.json with all required fields", async () => {
			...
			await fs.writeFile(path.join(tempDir, ".tasktronaut", "endpoints.json"), JSON.stringify(validConfig), "utf8")
	...
	describe("invalid JSON handling", () => {
		it("should throw ClineConfigurationError for invalid JSON syntax", async () => {
			await fs.writeFile(path.join(tempDir, ".tasktronaut", "endpoints.json"), "{ invalid json }", "utf8")
		...
		it("should throw ClineConfigurationError for truncated JSON", async () => {
			await fs.writeFile(path.join(tempDir, ".tasktronaut", "endpoints.json"), '{"appBaseUrl": "https://test.com"', "utf8")
		...
		it("should throw ClineConfigurationError for empty file", async () => {
			await fs.writeFile(path.join(tempDir, ".tasktronaut", "endpoints.json"), "", "utf8")
		...
		it("should throw ClineConfigurationError for non-object JSON", async () => {
			await fs.writeFile(path.join(tempDir, ".tasktronaut", "endpoints.json"), '"just a string"', "utf8")
		...
		it("should throw ClineConfigurationError for null JSON", async () => {
			await fs.writeFile(path.join(tempDir, ".tasktronaut", "endpoints.json"), "null", "utf8")
	...
	describe("missing required fields", () => {
		it("should throw ClineConfigurationError when appBaseUrl is missing", async () => {
			...
			await fs.writeFile(path.join(tempDir, ".tasktronaut", "endpoints.json"), JSON.stringify(config), "utf8")
	...
	describe("self-hosted mode behavior", () => {
		...
		it("should use custom endpoints from file", async () => {
			...
			await fs.writeFile(path.join(tempDir, ".tasktronaut", "endpoints.json"), JSON.stringify(customConfig), "utf8")
	...
	describe("bundled endpoints.json behavior", () => {
		...
		it("should prefer bundled endpoints.json over user file", async () => {
			...
			// Set up both configs
			await fs.writeFile(path.join(bundledDir, "endpoints.json"), JSON.stringify(bundledConfig), "utf8")
			await fs.writeFile(path.join(tempDir, ".tasktronaut", "endpoints.json"), JSON.stringify(userConfig), "utf8")
