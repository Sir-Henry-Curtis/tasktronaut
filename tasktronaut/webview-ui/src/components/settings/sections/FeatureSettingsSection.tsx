...
const agentFeatures: FeatureToggle[] = [
	{
		id: "subagents",
		label: "Subagents",
		description: "Let Tasktronaut run focused subagents in parallel to explore the codebase for you.",
...
const editorFeatures: FeatureToggle[] = [
	{
		...
		label: "Feature Tips",
		description: "Show rotating tips during the thinking phase to help you discover Tasktronaut features.",
...
const experimentalFeatures: FeatureToggle[] = [
	...
	},
	{
		...
		description: "Sometimes Tasktronaut just isn't feeling it today. For entertainment purposes only.",
