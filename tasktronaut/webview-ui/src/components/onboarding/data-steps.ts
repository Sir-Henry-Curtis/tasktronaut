...
export const USER_TYPE_SELECTIONS: UserTypeSelection[] = [
	...
	{ title: "Bring my own API key", description: "Use Tasktronaut with your OpenAI-compatible endpoint", type: NEW_USER_TYPE.BYOK },
]
