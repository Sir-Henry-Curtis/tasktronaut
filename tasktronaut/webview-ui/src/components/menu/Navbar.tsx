import { CheckSquare, HistoryIcon, PlusIcon, SettingsIcon } from "lucide-react"
...
export const Navbar = () => {
	const { navigateToHistory, navigateToSettings, navigateToMcp, navigateToChat, navigateToGsd } =
		useExtensionState()
	...
	const SETTINGS_TABS = useMemo(
		() => [
			...
			},
			{
				id: "gsd",
				name: "GSD",
				tooltip: "GSD Workflow",
				icon: CheckSquare,
				navigate: navigateToGsd,
			},
		],
		[navigateToChat, navigateToHistory, navigateToMcp, navigateToSettings, navigateToGsd],
	)
