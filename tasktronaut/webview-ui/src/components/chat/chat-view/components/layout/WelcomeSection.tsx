			...
			switch (action.action) {
				...
				case BannerActionType.SetModel: {
					...
					handleFieldsChange({
						...
						planModeOpenAiModelInfo: openRouterModels[modelId],
						actModeOpenAiModelInfo: openRouterModels[modelId],
								...
								{currentWorktree && (
									<Tooltip>
										...
										<TooltipContent side="bottom">
											View and manage git worktrees. Great for running parallel Tasktronaut tasks.
										</TooltipContent>
									</Tooltip>
								)}
							</div>
