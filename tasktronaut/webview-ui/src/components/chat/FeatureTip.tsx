...
const FEATURE_TIPS: FeatureTipItem[] = [
	{
		text: 'Enable "Double-Check Completion" in settings to have Tasktronaut verify its work before finishing a task.',
	},
	{
		text: "Add a project rules file to your repository root to give Tasktronaut project-specific instructions.",
	},
	{
		text: "Switch to Plan Mode to discuss and plan an approach before Tasktronaut takes action.",
	},
	{
		text: "Use @ in the chat input to add files, folders, or URLs as context for your task.",
	},
	{
		text: "Set up MCP Servers to give Tasktronaut access to external tools and APIs.",
	},
	{
		text: "Tasktronaut creates checkpoints after changes so you can restore a previous state if needed.",
	},
	{
	...
	{
		text: "Use the quote button to select text from Tasktronaut's response and reference it in your reply.",
	},
	{
		text: "You can drag and drop images into the chat to share screenshots with Tasktronaut.",
	},
	{
		text: "Tasktronaut can browse websites, including testing your local dev server in the browser.",
	},
	{
 ...
 * Appears after a brief delay and cycles through tips while Tasktronaut is thinking.
 */
