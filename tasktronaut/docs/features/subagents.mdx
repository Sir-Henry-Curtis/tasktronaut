...
- Cannot edit files, fetch external URLs, access MCP servers, or spawn nested subagents
...
Subagents cannot write files, apply patches, fetch external URLs, access MCP servers, or perform web searches. They also cannot spawn their own subagents.
