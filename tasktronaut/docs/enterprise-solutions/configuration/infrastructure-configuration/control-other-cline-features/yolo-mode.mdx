...
When YOLO Mode is enabled, Cline automatically approves all operations including file changes, terminal commands, external URL fetches, MCP operations, and mode transitions. This provides maximum automation speed but removes all safety guardrails.
